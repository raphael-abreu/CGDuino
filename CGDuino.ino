...
#This is a Black box conjugate gradient method, wich means that you don't have a matrix X 
#instead you have function or, in my case, a pattern that is repeated on the diagonal.
